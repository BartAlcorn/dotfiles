...
alias ~bp='$HOME/Projects/GIT/git.wmedia.tech/blueprint && oo'
alias ~bpl='$HOME/Projects/GIT/git.wmedia.tech/blueprint/lib'
...
alias ~gopo='$HOME/Projects/GO/src/goponents'
alias ~ctm='$HOME/Projects/GO/src/continuum'
alias ~wgx='$HOME/Projects/GO/src/wgx'
